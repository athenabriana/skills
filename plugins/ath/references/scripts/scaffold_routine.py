...
PROMPT = """\
Set ATH_UNATTENDED=1. Run /ath:implement against `.ath/tasks/{slug}/shape.md` in \
...
`claude/{slug}` branch. When the build is clean, chain into /ath:ship — open a \
...
def parse_args(argv: list[str]) -> argparse.Namespace:
    ...
    p.add_argument("--slug", help="The brief slug (.ath/tasks/<slug>/shape.md).")
