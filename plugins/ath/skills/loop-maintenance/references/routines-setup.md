# Unattended setup — running ath:loop-maintenance as Cloud Routines
...
- **Prompt (self-contained):** run `ath:loop-maintenance` Phase 1→3 for the triggering
...
- **Prompt:** run `ath:loop-maintenance` Phase 1→4 across **all** open PRs + alerts +
