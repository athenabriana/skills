...
A validated `.ath/tasks/<slug>/shape.md` (brief + a `## tasks` checklist). If there's no shaped brief for this work, stop and suggest `/ath:shape-idea` first — implementing without alignment is exactly what shaping prevents.
