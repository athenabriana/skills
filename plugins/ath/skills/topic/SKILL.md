---
name: topic
description: Deep research on any topic using parallel agents. Use when user says "research", "investigate", "deep dive into", "what do we know about", "explore the topic of", or asks a broad question requiring multi-source investigation. Do NOT use for code-specific research or finding repos (use /ath:code instead).
license: MIT
metadata:
...
- "Want me to switch to `/ath:code` to find implementations?"
