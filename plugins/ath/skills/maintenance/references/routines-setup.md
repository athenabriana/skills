# Unattended setup — running ath:maintenance as Cloud Routines
...
- **Prompt (self-contained):** run `ath:maintenance` Phase 1→3 for the triggering
...
- **Prompt:** run `ath:maintenance` Phase 1→4 across **all** open PRs + alerts +
