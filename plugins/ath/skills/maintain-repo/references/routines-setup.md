# Unattended setup — running ath:maintain-repo as Cloud Routines
...
- **Prompt (self-contained):** run `ath:maintain-repo` Phase 1→3 for the triggering
...
- **Prompt:** run `ath:maintain-repo` Phase 1→4 across **all** open PRs + alerts +
