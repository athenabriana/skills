...
maintenance guard — shared by every across-time skill (ship's watch loop,
night-shift, ath:digest-research).
...
Bundled as the ath plugin's PreToolUse hook (plugins/ath/hooks/hooks.json) — auto-activates when the plugin is enabled.
"""
